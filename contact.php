...
********************************************************************************************************** -->
<!-- Mirrored from kamleshyadav.com/healthcare/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Jul 2016 08:46:10 GMT -->

<!-- Mirrored from www.boomingbiomedicals.com/beta10/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Feb 2018 05:11:45 GMT -->
<head>
...
<!-- favicon links -->
<!-- favicon links -->
<link rel="shortcut icon" type="image/ico" href="images/fev.ico" />
<link rel="icon" type="image/ico" href="images/fev.ico" />
<!--Google web fonts-->
              ...
              <!-- <li><a>pages</a>
                <ul>
                  ...
                  <!-- <li><a>services</a>
					...
					<li><a href="services-four-column.html">Photo Gallery</a></li>
                  <!-- <li><a>profile</a>
                    <ul>
                      <li><a href="profile-single.html">Products</a></li>
                    </ul>
                  </li> -->
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3911.5433494264244!2d77.74219781480609!3d11.368027591921775!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x3c64a3a1924ba3b6!2sSree+Abirami+Tex!5e0!3m2!1sen!2sin!4v1520240074499" width="100%" height="400" frameborder="0" style="border:0" allowfullscreen></iframe>
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <div class="hs_contact_head_text">
        <h4 class="hs_contact_heading">Get in touch with us</h4>
        <p>For any enquiries kindly comment below with your details</p>
      </div>
    </div>
  </div>
  <div class="row">
      ...
      <div class="hs_comment_form">
		...
		<form action="email.php" method="post">	
          <div class="col-lg-6 col-md-6 col-sm-12">
				<!-- Input group for uname -->
				<div class="input-group"> 
					<span class="input-group-btn">
						  <button class="btn btn-success" type="button"><i class="fa fa-user"></i>
						  </button>
					</span>
        ...
        <div class="form-group">
			...
			<div class="col-lg-4 col-md-4 col-sm-12">
				...
				<input id="uemail"  type="submit" class="form-control" >
			</div>
		</div>
		</form>
</div>
    ...
    <div class="col-lg-4 col-md-5 col-sm-5">
      ...
      <div class="hs_contact" >
        <ul>
          <li> <i style="height:80px;" class="fa fa-map-marker"></i>
            <p>110, palaniappa Nagar,<br>
			Boys High School Road,<br>
			Lakshmi Mandabam Opp,<br>
			Pallipalayam,<br>
			Erode - 638008
          ...
          <li> <i class="fa fa-envelope"></i>
            <p><a href="mmanieee@gmail.com">mmanieee@gmail.com</a></p>
            <p><a href="sreeabiramee@gmail.com">sreeabiramee@gmail.com</a></p>
          </li>
        </ul>
      </div>
  ...
  <!-- <div class="row">
    <div class="col-lg-12">
      <div class="hs_contact_head_text">
        ...
        <p>Suspendisse ultrices sapien sit amet accumsan pharetra. Phasellus nec turpis neque. </p>
      </div>
    </div>
  </div> -->
...
<div class="hs_copyright"> Copyright © 2018 Touchsky  All Rights Reserved </div>
<!--footer end--> 
<!--main js file start--> 
